class puntos
{
    ...
    private String tostringaux(arbol a)//O(n) n es el tamaño del arbol
    {
        String d="";
        String c="";
        if(len==0)
    ...
    public void insertion(int a)//O(n) n es el tamaño del arbol
    {
        if(len==0)
        {
            arbol=new arbol(a);
    ...
    public boolean find(int a)//O(n) n es el tamaño del arbol
    {
        if(len==0)
        {
            return false;
